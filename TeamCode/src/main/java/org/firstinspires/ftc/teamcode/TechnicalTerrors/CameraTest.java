...
public class CameraTest extends LinearOpMode {
    ...
    private static int CAMERA_WIDTH = 1280; // width  of wanted camera resolution
    private static int CAMERA_HEIGHT = 960; // height of wanted camera resolution
